...
package cn.berfy.sdk.mvpbase.view.viewpager;
...
public class SpringIndicator extends FrameLayout {
    ...
    private void initAttrs(AttributeSet attrs) {
        textColorId = R.color.color_black;
        selectedTextColorId = R.color.color_titlebar_light_theme;
        indicatorColorId = R.color.color_titlebar_normal_small_title;
        textSize = getResources().getDimension(R.dimen.font_12);
        radiusMax = getResources().getDimension(R.dimen.space_24);
        radiusMin = getResources().getDimension(R.dimen.space_8);
