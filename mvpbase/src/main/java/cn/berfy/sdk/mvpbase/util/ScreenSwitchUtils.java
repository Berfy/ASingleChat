...
public class ScreenSwitchUtils {
            ...
            switch (msg.what) {
                case 888:
                    ...
                    if (orientation > 45 && orientation < 135) {
                        ...
                        if (onScreenSenseChangeListener != null) {
                            if (onScreenSenseChangeListener.getScreenOrientation() != ActivityInfo.SCREEN_ORIENTATION_LANDSCAPE) {
                                onScreenSenseChangeListener.onOnScreenSenseChange(ActivityInfo.SCREEN_ORIENTATION_LANDSCAPE);
                            }
                        } else {
                            if (isPortrait) {
                                Log.e(TAG, "切换成横屏");
                        ...
                        if (onScreenSenseChangeListener != null) {
                            if (onScreenSenseChangeListener.getScreenOrientation() != ActivityInfo.SCREEN_ORIENTATION_PORTRAIT) {
                                onScreenSenseChangeListener.onOnScreenSenseChange(ActivityInfo.SCREEN_ORIENTATION_PORTRAIT);
                            }
                        } else {
                            if (!isPortrait) {
                                Log.e(TAG, "切换成竖屏");
    ...
    private OnScreenSenseChangeListener onScreenSenseChangeListener;
    ...
    public interface OnScreenSenseChangeListener {
         ...
         */
        void onOnScreenSenseChange(int orientation);
     ...
     * 设置方向变化监听
     */
    public void setOnScreenSenseChange(OnScreenSenseChangeListener onScreenSenseChangeListener) {
        this.onScreenSenseChangeListener = onScreenSenseChangeListener;
    }
